...
const Story = () => {
  ...
  return (
    <section id="prolugue" className='mn-h-dvh w-screen bg-black text-blue-50'>
      <div className='flex size-full flex-col items-center py-10 pb-24'>
        ...
        <div className='-mt-80 flex w-full justify-center md:-mt-64 md:me-44 md:justify-end'>
          <div className='flex h-full w-fit flex-col itemas-center md:items-start'>
            ...
            <Button id="realm-button" title='discover prolugue' containerClass='mt-5' />
          </div>
        </div>
      </div>
    </section>
